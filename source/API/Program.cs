...
.AddJwtBearer(options =>
{
    options.TokenValidationParameters = new TokenValidationParameters
    {
        ...
        ValidAudiences = ["https://localhost:7258", "http://localhost:5173", "https://localhost:5173", "http://localhost:4200"],
...
builder.Services.AddCors(options =>
{
    ...
    {
        policy.WithOrigins("http://localhost:5173", "https://localhost:7258", "http://localhost:4200");
